...
import (
	...
	anthropicprovider "github.com/istxing/kingclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: kingclaw auth login --provider anthropic")
		}
