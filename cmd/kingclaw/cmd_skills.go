...
func skillsHelp() {
	...
	fmt.Println("  kingclaw skills list")
	fmt.Println("  kingclaw skills install istxing/kingclaw-skills/weather")
	fmt.Println("  kingclaw skills install-builtin")
	fmt.Println("  kingclaw skills list-builtin")
	fmt.Println("  kingclaw skills remove weather")
	fmt.Println("  kingclaw skills install --registry clawhub github")
}
...
func skillsInstallCmd(installer *skills.SkillInstaller, cfg *config.Config) {
	if len(os.Args) < 4 {
		fmt.Println("Usage: kingclaw skills install <github-repo>")
		fmt.Println("       kingclaw skills install --registry <name> <slug>")
		return
	}
	...
	if os.Args[3] == "--registry" {
		if len(os.Args) < 6 {
			fmt.Println("Usage: kingclaw skills install --registry <name> <slug>")
			fmt.Println("Example: kingclaw skills install --registry clawhub github")
			return
		}
...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./kingclaw/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "kingclaw", "skills")
